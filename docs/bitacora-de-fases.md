...
Decisiones y correcciones por fase, movidas desde `CLAUDE.md` el 10-09 para que ese archivo quede bajo el límite que Claude Code carga. Historial: se lee cuando hace falta el porqué de algo; el estado vigente está en `CLAUDE.md`.
