...
| 13 | Fase 3 | Consumidor `agent` sin rango temporal → `MISSING_TIME_RANGE`; `dashboard` con la misma consulta ejecuta. | curl agente sin rango → 400 MISSING_TIME_RANGE | OK (auto) |
